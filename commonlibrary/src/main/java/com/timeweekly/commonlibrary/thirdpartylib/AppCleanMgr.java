...
public class AppCleanMgr {
    ...
    public static void cleanInternalCache(Context context) {
    	...
    	CommonLogger.i("AppCleanMgr->>cleanInternalCache", "清除本应用内部缓存(/data/data/" + context.getPackageName() + "/cache)");
    }
    ...
    public static void cleanExternalCache(Context context) {
        if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
        	...
        	CommonLogger.i("AppCleanMgr->>cleanExternalCache", "清除本应用外部缓存数据(/mnt/sdcard/android/data/" + context.getPackageName() + "/cache)");
        }
    }
    ...
    public static void cleanDatabases(Context context) {
    	...
    	CommonLogger.i("AppCleanMgr->>cleanDatabases", "清除本应用所有数据库");
    }
    ...
    public static void cleanSharedPreference(Context context) {
    	...
    	CommonLogger.i("AppCleanMgr->>cleanSharedPreference", "清除本应用cleanSharedPreference数据信息");
    }
    ...
    public static void cleanDatabaseByName(Context context, String dbName) {
    	...
    	CommonLogger.i("AppCleanMgr->>cleanDatabaseByName", "根据名字清除本应用数据库");
    }
    ...
    public static void cleanFiles(Context context) {
    	...
    	CommonLogger.i("AppCleanMgr->>cleanFiles", "清除data/data/" + context.getPackageName() + "/files下的内容信息");
    }
    ...
    public static int cleanApplicationData(Context context) {
        ...
        //清除本应用files文件
        cleanFiles(context);
        CommonLogger.i("AppCleanMgr->>cleanApplicationData", "清除本应用所有的数据");
        return 1;
    }
    ...
    public static String getAppClearSize(Context context) {
    	...
    	CommonLogger.i("AppCleanMgr->>getAppClearSize", "获取App应用缓存的大小");
    	return fileSizeStr;
    }
